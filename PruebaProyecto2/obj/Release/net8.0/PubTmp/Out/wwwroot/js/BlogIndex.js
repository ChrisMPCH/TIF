...
function pageScrollFunction() {
    if (window.scrollY > 150) {
        ...
        document.querySelector('.main-navbar').style.marginTop = '70px'; // Baja el navbar
    } else {
        homeSection.classList.remove('active');
        document.querySelector('.main-navbar').style.marginTop = '0'; // Vuelve a la posición inicial
    }
}
